class DownloadPage{
    ...
    public verifyDownloadFileContent(){
        //cy.readFile(this.fileAddress).should("eq", this.expectedAddress);
        cy.readFile(this.fileAddress, 'base64').then(() => {
            // logo will be encoded as base64
            // and should look something like this:
            // aIJKnwxydrB10NVWqhlmmC+ZiWs7otHotSAAAOw==...
          }).should("eq", this.expectedAddress);
    }
}
